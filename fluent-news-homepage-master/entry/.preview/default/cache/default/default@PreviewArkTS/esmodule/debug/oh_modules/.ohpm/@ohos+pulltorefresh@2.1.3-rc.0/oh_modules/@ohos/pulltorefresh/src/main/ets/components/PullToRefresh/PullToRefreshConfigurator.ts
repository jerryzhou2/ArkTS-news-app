...
export class PullToRefreshConfigurator {
    ...
    private refreshCompleteTextHoldTime?: number = 1000; //下拉刷新完毕后, 刷新成功文本停留的时间
    ...
    private loadTextPullUp1?: ResourceStr = { "id": 16777544, "type": 10003, params: [], "bundleName": "com.example.newsdemo", "moduleName": "entry" }; // 上拉1阶段文本
    private loadTextPullUp2?: ResourceStr = { "id": 16777545, "type": 10003, params: [], "bundleName": "com.example.newsdemo", "moduleName": "entry" }; // 上拉2阶段文本
    private loadTextLoading?: ResourceStr = { "id": 16777541, "type": 10003, params: [], "bundleName": "com.example.newsdemo", "moduleName": "entry" }; // 上拉加载更多中时的文本
    ...
    getRefreshCompleteTextHoldTime(): number {
        return this.refreshCompleteTextHoldTime !== undefined ? this.refreshCompleteTextHoldTime : 1000;
    }
    ...
    setLoadTextPullUp1(loadTextPullUp1: ResourceStr) {
    ...
    setLoadTextPullUp2(loadTextPullUp2: ResourceStr) {
    ...
    setLoadTextLoading(loadTextLoading: ResourceStr) {
        this.loadTextLoading = loadTextLoading;
        return this;
    }
    getLoadTextLoading(): ResourceStr {
