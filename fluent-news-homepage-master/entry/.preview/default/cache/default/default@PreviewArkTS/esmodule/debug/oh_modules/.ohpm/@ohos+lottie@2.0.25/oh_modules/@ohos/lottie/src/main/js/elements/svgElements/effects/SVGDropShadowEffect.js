...
import SVGComposableEffect from '@package:pkg_modules/.ohpm/@ohos+lottie@2.0.25/pkg_modules/@ohos/lottie/src/main/js/elements/svgElements/effects/SVGComposableEffect';
import {
  extendPrototype,
