...
import TextAnimatorDataProperty from '@package:pkg_modules/.ohpm/@ohos+lottie@2.0.25/pkg_modules/@ohos/lottie/src/main/js/utils/text/TextAnimatorDataProperty';
import LetterProps from '@package:pkg_modules/.ohpm/@ohos+lottie@2.0.25/pkg_modules/@ohos/lottie/src/main/js/utils/text/LetterProps';
    ...
    if (letters[i].n) {
      ...
      if (this._hasMaskedPath) {
        ...
        if (documentData.ps) {
          ...
          matrixHelper.translate(documentData.ps[0], documentData.ps[1] + px2vp(documentData.ascent), 0);
        }
        switch (documentData.j) {
          case 1:
