...
import {
  ShapeModifier,
} from '@package:pkg_modules/.ohpm/@ohos+lottie@2.0.25/pkg_modules/@ohos/lottie/src/main/js/utils/shapes/ShapeModifiers';
import segmentsLengthPool from '@package:pkg_modules/.ohpm/@ohos+lottie@2.0.25/pkg_modules/@ohos/lottie/src/main/js/utils/pooling/segments_length_pool';
