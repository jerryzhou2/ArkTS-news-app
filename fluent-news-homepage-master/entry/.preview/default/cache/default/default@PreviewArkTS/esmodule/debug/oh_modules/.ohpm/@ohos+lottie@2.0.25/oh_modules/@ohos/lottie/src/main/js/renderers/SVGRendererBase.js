...
import SVGTextLottieElement from '@package:pkg_modules/.ohpm/@ohos+lottie@2.0.25/pkg_modules/@ohos/lottie/src/main/js/elements/svgElements/SVGTextElement'; // eslint-disable-line import/no-cycle
...
import NullElement from '@package:pkg_modules/.ohpm/@ohos+lottie@2.0.25/pkg_modules/@ohos/lottie/src/main/js/elements/NullElement';
...
SVGRendererBase.prototype.updateContentMode = function (contentMode) {
};
...
SVGRendererBase.prototype.changeColor = function (color, endColor, layer, index) {
  if (typeof endColor == 'object') {
    ...
    if (endColor == 0) {
      ...
      if (this.completeLayers || this.elements[endColor-1]) {
        this.elements[endColor-1].changeColor(color, endColor, layer);
      }
    }
  } else {
    var len = this.layers.length;
