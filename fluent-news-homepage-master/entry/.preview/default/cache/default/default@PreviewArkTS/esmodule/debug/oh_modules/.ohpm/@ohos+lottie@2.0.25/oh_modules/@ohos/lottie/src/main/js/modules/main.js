import { setLocationHref, setWebWorker } from '@package:pkg_modules/.ohpm/@ohos+lottie@2.0.25/pkg_modules/@ohos/lottie/src/main/js/main';
import animationManager from '@package:pkg_modules/.ohpm/@ohos+lottie@2.0.25/pkg_modules/@ohos/lottie/src/main/js/animation/AnimationManager';
import {
...
lottie.clearFileCacheSync = animationManager.clearFileCacheSync;
// lottie.start = start;
